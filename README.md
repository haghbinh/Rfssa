...
The use of the package starts with the decomposition of the functional
time series using fssa. Then a suitable grouping of the principal
compomnents is required for reconstruction. This can be done
...
components into additive functional time series whose sum approximates
the original univariate or multivariate functional time series
(freconstruct).
...
![](README_files/figure-gfm/example-4.png)<!-- -->

``` r
plot(U,d=10,type="periodogram")
```

![](README_files/figure-gfm/example-5.png)<!-- -->

``` r
plot(U,d=10,type="paired")
```

![](README_files/figure-gfm/example-6.png)<!-- -->

``` r
plot(U,d=10,type="wcor")
```

![](README_files/figure-gfm/example-7.png)<!-- -->
...
![](README_files/figure-gfm/example-8.png)<!-- -->
...
![](README_files/figure-gfm/example-9.png)<!-- -->
...
![](README_files/figure-gfm/example-10.png)<!-- -->
...
![](README_files/figure-gfm/example-11.png)<!-- -->
...
![](README_files/figure-gfm/example-12.png)<!-- -->
...
![](README_files/figure-gfm/example-13.png)<!-- -->
...
![](README_files/figure-gfm/example-14.png)<!-- -->
...
![](README_files/figure-gfm/example-15.png)<!-- -->
...
![](README_files/figure-gfm/example-16.png)<!-- -->

``` r
plot(U,d=10,type='paired')
```

![](README_files/figure-gfm/example-17.png)<!-- -->

``` r
plot(U,d=10,type='lheats', var = 1)
```

![](README_files/figure-gfm/example-18.png)<!-- -->

``` r
plot(U,d=10,type='lcurves',var = 1)
```

![](README_files/figure-gfm/example-19.png)<!-- -->

``` r
plot(U,d=10,type='lheats', var = 2)
```

![](README_files/figure-gfm/example-20.png)<!-- -->

``` r
plot(U,d=10,type='lcurves',var = 2)
```

![](README_files/figure-gfm/example-21.png)<!-- -->

``` r
plot(U,d=10,type='wcor')
```

![](README_files/figure-gfm/example-22.png)<!-- -->

``` r
plot(U,d=10,type='periodogram')
```

![](README_files/figure-gfm/example-23.png)<!-- -->

``` r
plot(U,d=10,type='vectors')
```

![](README_files/figure-gfm/example-24.png)<!-- -->
...
![](README_files/figure-gfm/example-25.png)<!-- -->
...
![](README_files/figure-gfm/example-26.png)<!-- -->
...
![](README_files/figure-gfm/example-27.png)<!-- -->
...
![](README_files/figure-gfm/example-28.png)<!-- -->
...
![](README_files/figure-gfm/example-29.png)<!-- -->
...
![](README_files/figure-gfm/example-30.png)<!-- -->
